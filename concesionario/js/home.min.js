...
//var BASE_URL = 'http://localhost/vertice/kia-wordpress/wp-content/themes/kia/';
//var BASE_URL = 'http://localhost:8000/kia/rediseno/kia-wordpress/wp-content/themes/kia/';
//var BASE_URL = 'http://kia.com.pe/dev/wp-content/themes/kia/';
...
(function(){
  ...
  $(document).on('ready', function(){
    Main.menuModelos();
    Main.menuDesplegableModelo();
    Main.footerMicrosites();
    //Main.submenuSobrekia();
    //Main.submenuPostventa();
  });

  /* ===========================================================================
  MENÚ MODELOS
  =========================================================================== */
  Main.menuModelos = function(){
    var submenuModelos = $('#submenu-modelos');
    var navsContainer = $('.ModelosMenu-navsContainer');
    var buttonCerrarSubmenu = $('.ModelosMenu-buttonClose');
    var buttonModelos = $('#button-menuModelos');

    var buttonMenuMobile = $('#button-menuMobile');
    var mainMenu = $('#mainMenu');

    /* ===========================================================================
    BOTÓN PARA DESPLEGLAR MODELOS
    =========================================================================== */
    buttonModelos.on('click', function(e){

      e.preventDefault();
      var self = $(this);
      var menuModeloDesplegable = $('.ModelosMenu-navsContainer');

      //AGREGAMOS SUBRAYADO AL BOTÓN MODELOS
      buttonModelos.toggleClass('is-pressed');

      if(navsContainer.css('display') === 'block'){
        ocultar();
      }else{
        mostrar();
      }
      ...
      function mostrar(){
        /**
         * El indicador de que el menú tenga o no el estilo responsive será la posición
         * static o absolute del contenedor del submenu modelos #submenu-modelos
         */
        if(submenuModelos.css('position') != 'static'){
        menuModeloDesplegable.css('height', $(document).height() + 'px' );

        /*$(window).resize(function(){
          overlayMainMenu.css('height', $(document).height() + 'px' );
        });*/

        //SUBMENÚ ESTILO TABLETS

          //MOSTRAMOS EL SUBMENÚ DE MODELOS CON UNA ANIMACIÓN DE IZQUIERDA A DERECHA
          navsContainer.css({
            'position':'relative',
            'left':'-280px',
            'display':'block'
          ...
          navsContainer.animate({
            'left':0
          }, 300, function(){

            //MOSTRAMOS EL BOTÓN DE CERRAR SUBMENÚ
            buttonCerrarSubmenu.delay(200).addClass('is-visible');
          });

        }else{
        //SUBMENÚ ESTILO DESKTOP
          $('#mainmenu-postventa-submenu').slideUp(200);
          $('#mainmenu-sobrekia-submenu').slideUp(200);
          navsContainer.slideDown(400);
        }
      }
      ...
      function ocultar(){
        ...
        if(submenuModelos.css('position') != 'static'){
          ...
          navsContainer.slideUp(300);
        }
      }

      //VALIDACIONES DEL RESPONSIVE AL REDIMENSIONAR EL NAVEGADOR
      $(window).resize(function() {

        if($('.ModelosMenu').css('position') === 'absolute' && $('.ModelosMenu-navsContainer').css('display') != 'none'){

          //MOSTRAMOS EL BOTÓN DE CERRAR SUBMENÚ
          buttonCerrarSubmenu.delay(200).addClass('is-visible');
          menuModeloDesplegable.css('height', $(document).height() + 'px' );

        }else if($('.ModelosMenu').css('position') === 'static'){

          //OCULTAMOS EL BOTÓN DE CERRAR SUBMENÚ
          buttonCerrarSubmenu.removeClass('is-visible');
          menuModeloDesplegable.css('height', 'auto' );
        }
      });
    ...
    =========================================================================== */
    buttonCerrarSubmenu.on('click', function(){

      //OCULTAMOS EL BOTÓN CERRAR
      $(this).removeClass('is-visible');

      //QUITAMOS SUBRAYADO AL BOTÓN "MODELOS"
      buttonModelos.toggleClass('is-pressed');

      //OCULTAMOS EL SUBMENU DE MODELOS
      navsContainer.hide();
    ...
    buttonMenuMobile.on('click', function(){
      ...
      //CAMBIAR IMAGEN DE FONDO DEL BOTÓN
      $(this).toggleClass('is-pressed');

      //MOSTRAR MENÚ PRINCIPAL ESTILO RESPONSIVE
      mainMenu.toggle();

    });

    /*! ==========================================================================
    RESIZE PARA MENÚ PRINCIPAL
    =========================================================================== */
    $(window).resize(function() {

      if (buttonMenuMobile.css('display') === 'none') {
        mainMenu.show();

        //QUITAMOS EL ESTADO PRESSED DEL BOTÓN MOBILE
        buttonMenuMobile.removeClass('is-pressed');

      }else if(buttonMenuMobile.css('display') === 'block' && buttonMenuMobile.hasClass('is-pressed') === false){
        mainMenu.hide();
      }
  ...
  SUBMENÚ MODELOS
  =========================================================================== */
  Main.menuDesplegableModelo = function(){

    var contenedorMenuModelos = $('.ModelosMenu-navsContainer');
    var containerButtonModelo = $('.ModelosMenu-item');
    var buttonModelo = $('.ModelosMenu-link');
    var contenedorAllDesplegables = $('.ModelosMenu-desplegableContainer');
    var contenedorImagenModelo = $('.ModelosMenu-imagenContainer');
    var textosBonoPrecio = $('.ModelosMenu-text');
    var mascaraDesplegable = $('.ModeloDesplegado-mascara');

    /*! ==========================================================================
    BOTÓN DE CADA MODELO
    =========================================================================== */
    buttonModelo.on('click', function(e){

      //Verificamos si el menú está en la versión responsive, es decir sin el desplegable
      /**
       * Si position = absolute, responsive está activo
       */
      var menuPosition = $('.ModelosMenu').css('position');
      var self = $(this);

      if(menuPosition != 'absolute'){

        //Evitamos que sigua el link
        e.preventDefault();

        //RESETAMOS LOS ESTILOS DEL MODELO ANTERIOR PRESIONADO y MOSTRAMOS BONOS Y PRECIOS
        contenedorImagenModelo.removeClass('is-pressed');
        textosBonoPrecio.show();

        //CORREMOS UNOS PIXELES HACIA ABAJO LA IMAGEN DEL MODELO
        self.children('.ModelosMenu-imagenContainer').addClass('is-pressed');

        //OCULTAMOS BONO Y PRECIOS
        self.children('.ModelosMenu-text').hide();

        //ANCHO DEL CONTENEDOR DE MENU MODELOS (980px o 700px)
        var anchoContenedorNavModelos = parseInt(contenedorMenuModelos.css('width'));

        //EL NÚMERO DE MODELOS A LOS QUE CAMBIAREMOS SU ALTURA SE CALCULA SEGÚN LA RESOLUCIÓN
        var modelosXFila;
        var altoFila;
        if (anchoContenedorNavModelos === 980) {
          modelosXFila = 6;
          altoFila = 395 - 15;
        } else if(anchoContenedorNavModelos === 700){
          modelosXFila = 4;
          altoFila = 313 - 10;
        }

        var posicion = self.parent().index();
        var numeroFilaActual = Math.floor(posicion / modelosXFila) + 1;
        var numNexts = (modelosXFila*numeroFilaActual) - (posicion+1);


        /**
         * CAMBIAMOS LA POSICIÓN DE LA MÁSCARA SEGÚN LA POSICIÓN
         * DEL MODELO CLICKEADO Y LA FILA EN QUE SE ENCUENTRA. El ALTO DE LA MÁSCARA ES 15px
         */
        var posicionYFondoMascara;

        if (anchoContenedorNavModelos === 700) {

          posicionYFondoMascara =  ((posicion - (modelosXFila * (--numeroFilaActual))) * -10) - 90;
          mascaraDesplegable.css({
            'background-position':'0px ' + posicionYFondoMascara.toString() +'px'
          });

        }else if(anchoContenedorNavModelos === 980){

          posicionYFondoMascara = (posicion - (modelosXFila * (--numeroFilaActual))) * -15;
          mascaraDesplegable.css({
            'background-position':'0px ' + posicionYFondoMascara.toString() +'px'
          });
        }

        //OCULTAR DESPLEGABLES DE CADA MODELO SIEMPRE QUE  HAYA UN SALTO DE RESOLUCIÓN
        var anchoActual = parseInt($('.ModelosMenu-navsContainer').css('width'));
        $(window).resize(function() {

          var anchoContenedorModelos = parseInt($('.ModelosMenu-navsContainer').css('width'));

          if (anchoContenedorModelos != anchoActual) {

            //OCULTAMOS LOS DESPLEGABLES DE CADA MODELO Y RESETAMOS LOS ESTILOS DEL MODELO PRESIONADO
            $('.ModelosMenu-imagenContainer').removeClass('is-pressed');
            $('.ModelosMenu-text').show();
            $('.ModelosMenu-item').removeAttr("style");
            contenedorAllDesplegables.hide();

            anchoActual = anchoContenedorModelos;
          }
        });

        //CAMBIAMOS LA ALTURA PARA PODER VER EL DESPLEGABLE
        containerButtonModelo.height('auto');
        self.parent().height(altoFila);
        self.parent().nextAll("*:lt(" +numNexts+ ")").css({
          'height' : altoFila
        });

        contenedorAllDesplegables.hide();
        self.next('.ModelosMenu-desplegableContainer').show();
      }
    });
  };
  ...
  SUBMENÚ SOBRE KIA
  =========================================================================== */
  Main.submenuSobrekia = function(){

    var submenuModelos = $('#submenu-modelos .ModelosMenu-navsContainer');
    var submenuPostventa = $('#mainmenu-postventa-submenu');
    var submenuSobreKia = $('#mainmenu-sobrekia-submenu');
    var sobrekiaLink = $('#mainmenu-sobrekia-link');

    sobrekiaLink.on('click', function(e){
      e.preventDefault();
      if( submenuModelos.css('display') === 'block' ){
        $('.MainMenu-link').removeClass('is-pressed');
        $('.MainMenu-submenu .ModelosMenu-navsContainer').slideUp(300);
        submenuPostventa.delay(300).slideDown(250);

      }else if( submenuPostventa.css('display') === 'block'){
        submenuPostventa.slideUp(250);
        submenuSobreKia.delay(300).slideDown(250);

      }else{

        submenuSobreKia.slideToggle(200);
      }
  ...
  SUBMENÚ POST-VENTA
  =========================================================================== */
  Main.submenuPostventa = function(){
    var submenuModelos = $('#submenu-modelos .ModelosMenu-navsContainer');
    var submenuPostventa = $('#mainmenu-postventa-submenu');
    var submenuSobreKia = $('#mainmenu-sobrekia-submenu');
    var postventaLink = $('#mainmenu-postventa-link');

    postventaLink.on('click', function(e){
      e.preventDefault();
      if( submenuModelos.css('display') === 'block' ){
        $('.MainMenu-link').removeClass('is-pressed');
        $('.MainMenu-submenu .ModelosMenu-navsContainer').slideUp(300);
      ...
      }else if(submenuSobreKia.css('display') === 'block'){
        submenuSobreKia.slideUp(250);
        submenuPostventa.delay(300).slideDown(250);
      }
      else{
        submenuPostventa.slideToggle(200);
      }
      //submenu.slideToggle(200);
  ...
  /* ===========================================================================
  MENU MICROSITES FOOTER
  =========================================================================== */
  Main.footerMicrosites = function(){
    var micrositesButton = $('#footer-btn-microsites');
    var micrositesMenu = $('#footer-menu-microsites');

    micrositesButton.on('click', function(){
      micrositesMenu.toggle();
    });
  };
...
(function(){
  ...
  AUDIO INTRO
  =========================================================================== */
  Home.sonidoIntro = function(){

    var cargador = new createjs.LoadQueue();
    createjs.Sound.alternateExtensions = ["mp3"];
    cargador.installPlugin(createjs.Sound);
    cargador.on("complete", cargaSonidoCompletado, this);
    cargador.loadManifest([
      {id:"sfx_intro", src:"sound/intro.ogg"}
    ]);

    function cargaSonidoCompletado(){
      var sfxIntro = createjs.Sound.play("sfx_intro", {loop:0});
      sfxIntro.volume = 0.1;
    }
  };
  ...
  =========================================================================== */
  Home.slidePreloader = function(){
    
    var slidesWrapper = $('#home-main-slide');
    var listaImagenes = [];

    slidesWrapper.find('li').each(function(i, val){
      var pathImg = $(val).find('img').attr('src');

      listaImagenes.push({id:i, src:pathImg});
    });
    ...
    function handleFileLoad(e){
      ...
      if(contSlides == 2){
        ...
        Home.slideInit();
        $('#home-slide-preloader').fadeOut(1000, function(){
          $('#home-slide').fadeIn(500);
        });
      }
      contSlides++;
    }
  ...
  /* ===========================================================================
  LIGHTBOX LLAMADO A REVISIÓN
  =========================================================================== */
  Home.llamadoRevision = function(){

    $("#home-banner-llamadorevision").fancybox({
      maxWidth  : 600,
      maxHeight : 600,
      fitToView : false,
      height    : '70%',
  ...
  Home.slideInit = function(){
    ...
    var mainSlide = $('#home-main-slide');
    var prevThumbnailButton = $('#prevThumbnail');
    var nextThumbnailButton = $('#nextThumbnail');


    var thumbnailsWrapper = $('#thumbnails-slide');
    var thumbnail = $('.HomeSlide-thumbnail');
    var numThumbnails = $('.HomeSlide-thumbnail').length;
    var movSpeed = 600;

	var banners = new Array();
	var htmlBanner = "";
    var htmlThumb = "";
    //Petición ajax hacia el api de los banners 
    $.ajax({
    	url: 'http://kia.com.pe/promociones/api/banners',
    	type: 'GET',
    	async: true,
    	dataType: "json",
    	success: function(data){
			...
			//Array que contendra los datos filtrados
			var bannersFinal = new Array();
			//Recorremos el array con la data y los datos filtrados los insertamos en el nuevo array
			for(var i = 0; i < banners.length; i++){
				if(banners[i].concesionario != "motorsurkia" && 
					banners[i].concesionario != "autodisakia" &&
					banners[i].concesionario != "interamericananorte" &&
					banners[i].concesionario != "interamericanatrujillo"){
					bannersFinal.push(banners[i]);
				}
			}
			console.log(bannersFinal);
			//Iteramos el nuevo array que contiene todos los banners
    		for(var i = 0; i < bannersFinal.length; i++){
				//Realizamos la condicional para que filtre el banner activo por defecto
				if(i === 0){
					var activeBan = "active first-child";
					var activeThumb = "active";
				}else{
					var activeBan = "";
					var activeThumb = "";
				}
				//Guardamos los banners en la variable correspondiente
				htmlBanner += '<li data-slide="'+ i +'" class="'+ activeBan +'"><a href="'+ bannersFinal[i].enlace +'"><img src="'+ bannersFinal[i].imagen +'"></a></li>';
				htmlThumb += '<li data-slide="'+ i +'" class="HomeSlide-thumbnail '+ activeThumb +'"><img src="'+ bannersFinal[i].imagen +'"></li>';
			}
			//Agregamos la data a su respectivo contenedor
    		mainSlide.html(htmlBanner);
    		thumbnailsWrapper.html(htmlThumb);
    ...
    /* ===========================================================================
    ANCHO DINÁMICO DEL CONTENEDOR DE MINIATURAS
    =========================================================================== */
    thumbnailsWrapper.width( (numThumbnails+1) * 211);


    /* ===========================================================================
    EVENTOS PARA NAVEGAR EL SLIDE MINIATURAS
    =========================================================================== */
    function addNavPagerEvents(){
      ...
      thumbnail.on('click', function(){
        ...
        //Activamos el thumbnail clickeado
        var thumbnailActivo = $('#thumbnails-slide .active');
      ...
      prevThumbnailButton.on('click', function(){
        ...
        //Activamos el anterior thumbnail
        var thumbnailActivo = $('#thumbnails-slide .active');
        thumbnailActivo.removeClass('active');
      ...
      nextThumbnailButton.on('click', function(){
        ...
        //Activamos el siguiente thumbnail
        var thumbnailActivo = $('#thumbnails-slide .active');
        thumbnailActivo.removeClass('active');
    ...
    function moveThumbnailsSlide(button){
      ...
      if(buttonName === 'prevThumbnail'){
        ...
        thumbnailsWrapper.animate({
          ...
          //Movemos la miniatura que quedó oculta a la izquierda hacia el final de miniaturas
    ...
    /* ===========================================================================
    REMOVER TODOS LOS EVENTOS DE CAMBIO DE SLIDE
    =========================================================================== */
    function removeAllEvents(){
      //Resteamos el autoslide
    ...
    /* ===========================================================================
    ACTIVAR EL THUMBNAIL: CLICKEADO, ANTERIOR O SIGUIENTE
    =========================================================================== */
    function activeThumbnail(thumbnail) {
      ...
      imgToShow.fadeTo(600, 1, function(){
        ...
        //Activamos nuevamente el autoSlide
        startAutoSlide();
  ...
  BANNERS
  =========================================================================== */
  Home.banners = function(){
    $('#home-banner-slide').bxSlider({
      prevSelector:'.HomeBanners-prevButton',
      nextSelector:'.HomeBanners-nextButton',
      minSlides: 2,
      maxSlides: 4,
      slideWidth: 220,
      slideMargin: 15,
